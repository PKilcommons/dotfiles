...
set fish_color_command 66D9EF # the color for commands
set fish_color_quote E6DB74 # the color for quoted blocks of text
set fish_color_redirection AE81FF --bold # the color for IO redirections
set fish_color_end F8F8F2 # the color for process separators like ';' and '&'
set fish_color_error F92672 # the color used to highlight potential errors
set fish_color_param FD971F # the color for regular command parameters
set fish_color_option -i E3E3DD 
set fish_color_comment 8D8282 # the color used for code comments
